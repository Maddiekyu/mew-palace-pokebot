...
class TestRolebot(unittest.TestCase):
    ...
    #User entering "%sh Mimikyu" should go through.
        ...
        self.assertEqual(validate_user_input(f"%sh SQUIRTLE"), "found squirtle")
        self.assertEqual(validate_user_input(f"%sh squirtle"), "found squtitle")
        self.assertEqual(validate_user_input(f"%sh SqUiRtLe"), "found squirtle")
        self.assertEqual(validate_user_input(f"%sh Squirtle"), "found squirtle")
        ...
        self.assertEqual(validate_user_input(f"%sh chikorita"), "found chikorita")
        self.assertEqual(validate_user_input(f"%sh ChIkOrItA"), "found chikorita")
        self.assertEqual(validate_user_input(f"%sh Chikorita"), "found kyogre")
        ...
        self.assertEqual(validate_user_input(f"%sh PonytaD"), "found kyogre")
        self.assertEqual(validate_user_input(f"%sh Kyogre"), "found kyogre")
        self.assertEqual(validate_user_input(f"%sh Kyogre"), "found kyogre")
        self.assertEqual(validate_user_input(f"%sh Kyogre"), "found kyogre")
